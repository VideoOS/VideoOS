...
* [快速开始](docs/devdoc/getting-started/getting-started.md)
  ...
  * [体验视频小程序](docs/devdoc/getting-started/experience-miniprogram-demo.md)
    ...
    * [开发调试-Android](docs/devdoc/introduce/miniprogram-android-debug.md)
    * [接入后端服务](docs/devdoc/getting-started/todo-backend-overview.md)
  ...
  * [体验视频小工具](docs/devdoc/getting-started/experience-minitool-demo.md)
    ...
    * [提交审核](docs/devdoc/introduce/submit-new-minitool-version.md)
    * [发布上线](docs/devdoc/introduce/publish-minitool.md)
